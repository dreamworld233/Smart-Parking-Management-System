> ⚠️ **本文档已作废（2026-09-11）。** 其定义的范围是「到达即停 MVP，不做未来时段预约」，与需求基线（`02-需求分析与设计方案-23软工2班第4组.docx`，2026-09-10 定稿）的核心「未来时段预约锁位」直接冲突。
> 生效文档：`docs/superpowers/specs/2026-09-11-smart-parking-miniprogram-ui-design.md`。以下内容仅作历史参考。
